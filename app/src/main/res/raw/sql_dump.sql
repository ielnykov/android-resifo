CREATE TABLE Country (code VARCHAR (2) PRIMARY KEY NOT NULL, name VARCHAR (1, 100) NOT NULL);
...
CREATE TABLE Entry (entryID INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL,	userID INTEGER NOT NULL REFERENCES User (userID) ON DELETE CASCADE ON UPDATE CASCADE,	lastName VARCHAR (2, 20) NOT NULL,	firstName VARCHAR (2, 30) NOT NULL,	maidenName VARCHAR (2, 20),	religion VARCHAR (2, 20) NOT NULL,	placeOfBirth VARCHAR (2, 40) NOT NULL,	martialStatus INTEGER NOT NULL,	nationality VARCHAR (2) NOT NULL REFERENCES Country (code) ON DELETE RESTRICT ON UPDATE CASCADE,	zmr CHAR (12),	travelDocumentID VARCHAR (2, 20),	travelDocumentNumber INTEGER,	travelDocumentAuthority VARCHAR (2, 30),	travelDocumentCountry VARCHAR (2) REFERENCES Country (code) ON DELETE RESTRICT ON UPDATE CASCADE,	travelDocumentDate DATE,	dateCreated DATE DEFAULT (datetime('now', 'localtime')) NOT NULL,	r_street VARCHAR (2, 30) NOT NULL,	r_housenumber VARCHAR (1, 4) NOT NULL,	r_apartment VARCHAR (2, 20),	r_door VARCHAR (1, 4),	r_postalCode CHAR (4) NOT NULL,	r_city VARCHAR (2, 20) NOT NULL,	r_mainResidence BOOLEAN NOT NULL,	r_abroad BOOLEAN NOT NULL,	r_abroadCountry VARCHAR (2) REFERENCES Country (code),	c_street VARCHAR (2, 30),	c_housenumber VARCHAR (1, 4),	c_apartment VARCHAR (2, 20),	c_door VARCHAR (1, 4),	c_postalCode CHAR (4),	c_city VARCHAR (2, 20),	c_movingAbroad BOOLEAN NOT NULL,	c_movingAbroadCountry VARCHAR (2) REFERENCES Country (code),	landlord_name VARCHAR (2, 30),	landlord_date DATE,	landlord_signaturePath VARCHAR (2, 40),	user_date DATE NOT NULL,	user_signaturePath VARCHAR (2, 40) NOT NULL	);
CREATE TABLE User (userID INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, lastName VARCHAR (2, 20) NOT NULL,	firstName VARCHAR (2, 30) NOT NULL,	maidenName VARCHAR (2, 20),	dateOfBirth DATE NOT NULL,	gender CHAR (1) NOT NULL,	religion VARCHAR (2, 20),	placeOfBirth VARCHAR (2, 40) NOT NULL,	martialStatus INTEGER NOT NULL,	nationality VARCHAR (2) NOT NULL REFERENCES Country (code) ON DELETE RESTRICT ON UPDATE CASCADE,	zmr CHAR (12),	travelDocumentID VARCHAR (2, 20),	travelDocumentNumber INTEGER,	travelDocumentAuthority VARCHAR (2, 30),	travelDocumentCountry VARCHAR (2) REFERENCES Country (code) ON DELETE RESTRICT ON UPDATE CASCADE,	travelDocumentDate DATE,	dateCreated DATE DEFAULT (datetime('now', 'localtime'))	);